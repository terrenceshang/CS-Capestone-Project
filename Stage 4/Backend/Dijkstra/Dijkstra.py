...
def main():
    ...
    previous_nodes, shortest_path = dijkstra_algorithm(graph=graph, start_node="Strand")
    print_result(previous_nodes, shortest_path, start_node="Strand", target_node="Worcester")
